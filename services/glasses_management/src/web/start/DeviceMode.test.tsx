...
describe('端末の使い方', () => {
  it('個人と共有の違いと、あとから変更できることを読める', () => {
    render(<DeviceMode deviceLabel="EYEX-iPad-07" onPersonal={vi.fn()} onShared={vi.fn()} />)
    ...
    expect(screen.getByText(/設定 › 端末/)).toHaveTextContent('EYEX-iPad-07')
  })

  it('2つの使い方へ進める', () => {
    const onPersonal = vi.fn()
    const onShared = vi.fn()
    render(<DeviceMode deviceLabel="EYEX-iPad-07" onPersonal={onPersonal} onShared={onShared} />)
